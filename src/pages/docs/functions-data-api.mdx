...
▸ commitUnitOfWork(unitOfWork: UnitOfWork): Promise<Map<string, [RecordModificationResult](#RecordModificationResult)>>
...
Returns: Promise<Map<string, [RecordModificationResult](#RecordModificationResult)>>
