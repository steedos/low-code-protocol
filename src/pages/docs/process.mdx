...
after_insert_entry_criteria: "", # 入口公式 传入 (userSession, Record)
after_update_entry_criteria: "", # 入口公式 传入 (userSession, Record)
```
...
after_insert_entry_criteria: "", # 入口公式
after_update_entry_criteria: "", # 入口公式
```

### 流程图 .process.${engine}.bpmn
